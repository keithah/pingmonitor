...
// Menu Bar Controller with Perfect Alignment
class MenuBarController: ObservableObject {
    ...
    private func setupMenuBar() {
        // Set specific width for consistent alignment
        ...
        // Set button properties for better alignment
    ...
    private func updateStatusDisplay() {
        ...
        if let result = pingService.latestResult {
            // Status emoji - smaller and centered
            ...
            // Ping time - centered and smaller
            ...
            attributedString.append(NSAttributedString(string: "--", attributes: timeAttributes))
        }
